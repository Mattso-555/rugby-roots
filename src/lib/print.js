...
export function coverHTML(data) {
  ...
  return `
    <section class="pc-cover">
      <div class="pc-brand"><img src="/crest.png" alt="" style="height:16mm;display:block;margin:0 auto 3mm" /> Glasgow Accies RFC</div>
      ...
      <div class="pc-foot">Glasgow Accies RFC · fun, confidence &amp; participation first</div>
    </section>`;
}
