...
export const KIT = {
  ...
  ring:   { label: "◎ Tackle ring",   hit: 1.2 },
  tube:   { label: "▮ Tackle tube",   hit: 1.2 },
  dummy:  { label: "◇ Mannequin",     hit: 1.1 },
  ball:   { label: "🏉 Ball",         hit: 0.9 },
  tee:    { label: "⊤ Kicking tee",   hit: 0.9 },
  coach:  { label: "👤 Coach",        hit: 1.1 },
...
export function kitSummary(course) {
  ...
  const names = {
    ...
    ring: ["tackle ring", "tackle rings"], tube: ["tackle tube", "tackle tubes"],
    dummy: ["mannequin", "mannequins"], tee: ["kicking tee", "kicking tees"],
    coach: ["coach", "coaches"],
  };
