...
export default function App() {
  ...
  // Squad-wide "what to bring" — one note every parent sees. Lives on team,
  // so it travels in backups and syncs with the rest of the team section.
  const setWhatToBring = (bring, flatText) =>
    setData((prev) => ({ ...prev, team: { ...(prev.team || {}), bring, whatToBring: flatText || "" } }));
