...
export default function App() {
  ...
  useEffect(() => {
    (async () => {
      ...
      const base = { team:{ name:"My Squad", ageGrade:null }, players:[], plan:null, planName:null, progress:{}, attendance:{}, customActivities:[], customSessions:[], extras:{} };
      ...
      <main className="max-w-2xl mx-auto px-4 pt-4">
        {mode === "parent" ? (
          ...
          <>
            ...
            {tab === "sessions" && (
              <Sessions data={data} setPlan={setPlan} setSlot={setSlot} moveWeek={moveWeek} setOwnWeek={setOwnWeek} setAttendance={setAttendance} toggleAttendance={toggleAttendance}
