...
import { buildSingle, resolveSlot, wState, planBreachesAge } from "./lib/helpers.js";
...
export default function App() {
  ...
  useEffect(() => {
    (async () => {
      ...
      const base = { team:{ name:"My Squad", ageGrade:null }, players:[], plan:null, planName:null, progress:{} };
