  ...
  "weeks": [
    {
      ...
      "activities": [
        ...
        },
        {
          ...
          "play": "The tackler walks in, places the SHOULDER into the middle of the bag with the head to the side ('cheek to cheek'), wraps both arms around and drives two short steps. Reset, swap roles. Everything at walking pace.",
          ...
          "points": [
            "Shoulder in, head to the side and safe",
    ...
    },
    {
      ...
      "activities": [
        ...
        },
        {
          ...
          "condition": "No shout, no tackle — and each defender must use both shoulders across the game.",
    ...
    },
    {
      ...
      "activities": [
        ...
        },
        {
          ...
          "condition": "A point for the defence whenever the tackler beats the ball back to their feet.",
    ...
    },
    {
      ...
      "activities": [
        ...
        },
        {
          ...
          "condition": "A tackle only scores if it is side-on, safe, and the tackler gets back to their feet.",
