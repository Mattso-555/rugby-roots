...
import { signInWithEmail, verifyEmailCode } from "../lib/supabaseClient.js";
        ...
        <div className="rounded-2xl p-4" style={{ background: "#fff" }}>
          {!sent ? (
            ...
            <>
              ...
              <p className="text-sm mt-1" style={{ color: C.mute }}>
                An email is on its way to <b>{email.trim()}</b>. It contains a
                <b> 6-digit code</b> — type it below. (Tapping the link in the
                email works too, on this device.)
              </p>
