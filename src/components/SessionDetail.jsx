...
import { displaySlots, SLOT_LABELS } from "../lib/weekEdits.js";
  ...
  return (
    <div className="space-y-4">
      ...
      <button onClick={() => {
          ...
          const attached = ((data && data.weekCourses && data.weekCourses[blockWeek]) || [])
            .filter((id) => !slotIds.includes(id))
            .map((id) => (data.courses || []).find((c) => c.id === id))
            .filter(Boolean);
          printSession(blockWeek, r, players, { slots, extras, attached });
        }}
