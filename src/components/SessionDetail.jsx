...
export default function SessionDetail({ r, blockWeek, st, players, back, toggleDone, setReflection, data, recordObservation, setAttendance, toggleAttendance, saveCustom, deleteCustom, attachCustom, detachCustom }) {
  ...
  const activities = data && !isOwn ? activitiesForSlot(data, skillId, session, w.activities) : w.activities;
  return (
    <div className="space-y-4">
      ...
      {activities.map((a, i) => <ActivityCard key={a.id || i} a={a} count={count} />)}
