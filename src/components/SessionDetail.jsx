...
export default function SessionDetail({ r, blockWeek, st, players, back, toggleDone, setReflection, data, setAttendance, toggleAttendance, saveCustom, deleteCustom, attachCustom, detachCustom }) {
