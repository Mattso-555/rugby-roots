...
export default function SessionDetail({ r, blockWeek, st, players, back, toggleDone, setReflection, data, recordObservation, setAttendance, toggleAttendance, saveCustom, deleteCustom, attachCustom, detachCustom, setPlanB }) {
