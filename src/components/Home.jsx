...
export default function Home({ data, ageGrade, setAgeGrade, onRestore, goTab, onClose }) {
  return (
        ...
        <div className="flex items-center justify-between pt-2">
          <div className="flex items-center gap-2.5">
            <span className="flex items-center justify-center rounded-xl"
              style={{ width: 38, height: 38, background: C.pine, fontSize: 19 }}>🌱</span>
            <div className="leading-tight">
              <div className="font-display font-extrabold" style={{ fontSize: 20, color: C.pine }}>Rugby Roots</div>
