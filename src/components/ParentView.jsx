...
import { C, AWARDS, LEVELS, LEVEL_COLOR, AREAS } from "../data/constants.js";
import { resolveSlot, wState } from "../lib/helpers.js";
import { Card, Label, SectionTitle, Pill, LevelDot } from "./ui.jsx";
    ...
    <div className="space-y-4">
      ...
      <Card><div className="p-4">
        ...
        <div className="mt-2 text-sm space-y-1.5">
          ...
          <div className="flex gap-2"><span>🎒</span> Please bring: water, boots, warm layers</div>
