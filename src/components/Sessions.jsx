...
import { PRESETS, resolveSlot, wState, doneCount, buildSingle } from "../lib/helpers.js";
...
export default function Sessions({ data, setPlan, setSlot, openWeek, setOpenWeek, toggleDone, setReflection }) {
