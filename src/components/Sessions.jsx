...
export default function Sessions({
  data, ageGrade, setPlan, setSlot, moveWeek,
  setAttendance, toggleAttendance,
  ...
  if (plan && openWeek) {
    ...
    return (
      <SessionDetail r={r} blockWeek={openWeek} st={st} players={data.players}
        ...
        data={data} setAttendance={setAttendance} toggleAttendance={toggleAttendance}
  ...
  if (building) {
    return (
      <BlockBuilder data={data} ageGrade={ageGrade}
        setPlan={setPlan} setSlot={setSlot} moveWeek={moveWeek}
