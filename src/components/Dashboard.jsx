...
import { PRESETS, resolveSlot, wState, doneCount, buildSingle, recommendFocus, recommendSkill } from "../lib/helpers.js";
import { printBlock } from "../lib/print.js";
import { Card, Label, SectionTitle, Pill, MiniStat, Icon } from "./ui.jsx";
import BackupCard from "./BackupCard.jsx";

export default function Dashboard({ data, goSetup, goPlayers, setPlan, onRestore, openWeekFn }) {
  ...
  const suggested = recommendSkill(data.players);
  ...
  return (
    <div className="space-y-4">
        ...
        <Card className="pitch-hero rr-rise">
          <div className="p-5 text-white">
            ...
            <p className="text-sm opacity-90 mt-2">
              Load the recommended <b>Match ready</b> block, focus on one skill, or build your own week-by-week mix.
            </p>
            <div className="flex flex-wrap gap-2 mt-4">
              <button onClick={() => setPlan(PRESETS.matchready.slots, PRESETS.matchready.name)}
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <Card><div className="p-4">
          <div className="font-display text-3xl font-extrabold" style={{ color: C.pine }}>{Object.keys(SKILLS).length}</div>
