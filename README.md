...
The very first time the app opens it shows a welcome screen: what the app does,
and one required choice — your squad's age grade. You can't get past it without
picking, which is deliberate. It isn't
...
**Home &amp; settings.** Tap the Rugby Roots logo in the top-left of any screen
to open the home panel: a short map of where everything lives (each entry jumps
to that tab), and the settings — change the age grade, back up or restore, and
a start-again option. Moving settings here keeps the Today screen focused on
tonight's session.
...
**When the night goes sideways.** Every session has a **Plan B** card. Raining
hard, stuck in a hall, a coach short, too few for the games — tick what's
changed (tick several if it's that kind of night) and the activities swap to
ones that still work, staying on that week's skill so the block keeps moving.
Each swap says which week it borrowed from, and if nothing fits everything you
ticked, it says so plainly rather than quietly handing you something off-skill.
Untick and the plan comes straight back. Every built-in activity carries the
one-line tags that drive this in `src/data/` — edit them if you disagree with
a judgment.

**The note that comes back.** At the bottom of every session, "How did tonight
go?" takes one line — what worked, what you'd change. The next time you coach
that skill, your last note appears at the top of the session, so "gates too
close together" actually gets fixed instead of forgotten.

---

**Noting how they got on.** Once you've taken the register, the players who
are in appear as a quick list — tap any of them to jot a short note while it's
fresh. A note is all it needs; you can nudge a skill level too if you saw
something clear, but you never have to. Children who aren't there don't appear.

Turning up on its own never changes a child's skills — attendance and progress
are kept honest and separate. The one place they meet is a pair of gentle flags on the
**Players** tab: if a child has been coming along but you haven't noted anything
about them, the app quietly says so, to help you catch the quiet one before they
slip through. And if a child who'd been coming regularly has missed the last
two registers in a row, it mentions that too — children usually drift for a
while before they stop, and a friendly message home at the right moment keeps
more of them. The flag clears itself the moment they're back. It's about attention, not scoring — there are no streaks,
leaderboards or rankings anywhere, which is deliberate for this age group.

## Part 5 — Your library: bespoke activities and sessions

There's a **Library** tab in the bottom bar. Everything you build lives there,
away from any single session, so it's easy to find and reuse.

**Activities** are the building blocks — a warm-up, a skill drill or a game.
Tap **Write one**, and the guided form walks you through it: how it's set up,
how it runs, your coaching points, and (for a game) the condition that makes
the skill show up. You can add a picture without drawing — pick a layout and it
draws to your pitch size, or nudge players and arrows around by hand.

**Sessions** are a whole night's plan: your warm-up, your skill activity and
your game, together. Tap **Build a session**, name it, and choose one activity
for each slot — or write a new one on the spot. 

**Skills courses** are the third thing in your library: a whole circuit laid
out on a much bigger area — up to 80m each way. Tap **Design a course** and
place kit by touching the area: a start gate, gates, cones, spots, tackle
bags, hit shields, an agility ladder, hurdles, slalom poles, balls, numbered
station markers, arrows for the route and labels for anything else. Drag to
nudge, rotate what needs rotating, and zoom in when placing something fiddly.
Distances are real metres, so a saved course can be paced out and set up
identically every week — name it, add a "how it runs" note, and it's there
whenever you need it.

Once a session is in your library, it drops straight into your block. On the
**Sessions → Build / rearrange** screen, tap **Change skill** on any week and
your own sessions appear at the top under **My sessions** — pick one and that
week becomes your session, register and all. That's how a bespoke session
becomes part of a six-week course.

Everything in your library is saved on your device and travels in your backup
file, so updating the app never loses it.
...
src/
  ...
  lib/
    ...
    planB.js            Last-minute session substitutions
    fading.js           The fading-attendance flag
    courses.js          Skills course kit and helpers
